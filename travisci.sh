...
export MAIN_PLATFORMS='declare -A main_platforms=( [generic]="esp8266:esp8266:generic" [nodemcuv2]="esp8266:esp8266:nodemcuv2" )'

# associative array for other platforms that can be called explicitly in .travis.yml configs
# this will be eval'd in the functions below because arrays can't be exported
export AUX_PLATFORMS='declare -A aux_platforms=( [nodemcu]="esp8266:esp8266:nodemcu" )'
...
ln -s $PWD $HOME/arduino_ide/libraries/ESP8266WiFiAPSta
